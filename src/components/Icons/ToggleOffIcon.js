...
export default function ToggleOffIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M8 7c-2.756 0-5 2.244-5 5s2.244 5 5 5 5-2.244 5-5c0-2.756-2.244-5-5-5zM8 16c-2.206 0-4-1.794-4-4s1.794-4 4-4 4 1.794 4 4c0 2.206-1.794 4-4 4z" />
    </svg>
