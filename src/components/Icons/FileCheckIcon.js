...
export default function FileCheckIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M10.497 16.794l-1.997-2-0.706 0.706 2.35 2.353c0.094 0.094 0.222 0.147 0.353 0.147 0 0 0 0 0 0 0.131 0 0.259-0.053 0.353-0.147l5.356-5.353-0.706-0.709-5.003 5.003z" />
    </svg>
