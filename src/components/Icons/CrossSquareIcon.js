...
export default function CrossSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M8.456 16.956l3.544-3.541 3.537 3.534 1.413-1.413-3.534-3.537 3.541-3.544-1.413-1.413-3.544 3.541-3.537-3.534-1.413 1.413 3.534 3.537-3.541 3.544z" />
    </svg>
