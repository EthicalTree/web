...
export default function ChevronDownSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M12 16c0.256 0 0.513-0.097 0.706-0.294l5.25-5.25-1.416-1.416-4.541 4.544-4.544-4.541-1.416 1.416 5.25 5.25c0.197 0.194 0.453 0.291 0.709 0.291z" />
    </svg>
