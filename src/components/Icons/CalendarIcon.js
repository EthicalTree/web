...
export default function CalendarIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M4 9.5v10c0 0.275 0.225 0.5 0.5 0.5h15c0.275 0 0.5-0.225 0.5-0.5v-10c0-0.275-0.225-0.5-0.5-0.5h-15c-0.275 0-0.5 0.225-0.5 0.5zM5 15h4v4h-4v-4zM14 15v4h-4v-4h4zM10 14v-4h4v4h-4zM15 19v-4h4v4h-4zM19 14h-4v-4h4v4zM9 10v4h-4v-4h4z" />
    </svg>
