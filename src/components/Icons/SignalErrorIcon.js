...
export default function SignalErrorIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M7 22h4v2h-4v-2z" />
      <path d="M1 22h4v2h-4v-2z" />
      <path d="M8.5 3.794l-2 2-2-2-0.706 0.706 2 2-2 2 0.706 0.706 2-2 2 2 0.706-0.706-2-2 2-2z" />
