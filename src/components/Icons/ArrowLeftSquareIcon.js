...
export default function ArrowLeftSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M10.544 16.956l1.416-1.416-2.544-2.541h8.584v-2h-8.584l2.544-2.544-1.416-1.416-4.25 4.25c-0.391 0.391-0.391 1.025 0 1.416l4.25 4.25z" />
    </svg>
