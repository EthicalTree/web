...
export default function ChevronRightSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M10.456 17.956l5.25-5.25c0.391-0.391 0.391-1.025 0-1.416l-5.25-5.25-1.416 1.416 4.544 4.544-4.541 4.544 1.413 1.413z" />
    </svg>
