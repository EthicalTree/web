...
export default function CanvasLeftIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      <path d="M9 15c1.653 0 3-1.347 3-3s-1.347-3-3-3-3 1.347-3 3 1.347 3 3 3zM9 10c1.103 0 2 0.897 2 2s-0.897 2-2 2-2-0.897-2-2c0-1.103 0.897-2 2-2z" />
