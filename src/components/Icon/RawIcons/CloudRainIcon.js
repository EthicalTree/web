...
export default function CloudRainIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M3 18h1v3h-1v-3z" />
      <path d="M5 21h1v3h-1v-3z" />
      <path d="M7 18h1v3h-1v-3z" />
      <path d="M9 21h1v3h-1v-3z" />
      <path d="M11 18h1v3h-1v-3z" />
      <path d="M13 21h1v3h-1v-3z" />
      <path d="M15 18h1v3h-1v-3z" />
      <path d="M17 21h1v3h-1v-3z" />
      <path d="M19 18h1v3h-1v-3z" />
      <path d="M21 21h1v3h-1v-3z" />
    </svg>
