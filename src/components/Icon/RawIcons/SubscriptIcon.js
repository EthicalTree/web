...
export default function SubscriptIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      <path d="M12.544 4.044l-4.044 4.041-4.044-4.041-1.413 1.413 4.041 4.044-4.041 4.044 1.413 1.413 4.044-4.041 4.044 4.041 1.413-1.413-4.041-4.044 4.041-4.044z" />
