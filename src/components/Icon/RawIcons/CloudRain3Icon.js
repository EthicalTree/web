...
export default function CloudRain3Icon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M0.8 22.6l3.6-4.8 0.8 0.6-3.6 4.8-0.8-0.6z" />
      <path d="M4.8 22.6l3.6-4.8 0.8 0.6-3.6 4.8-0.8-0.6z" />
      <path d="M8.8 22.6l3.6-4.8 0.8 0.6-3.6 4.8-0.8-0.6z" />
      <path d="M12.8 22.6l3.6-4.8 0.8 0.6-3.6 4.8-0.8-0.6z" />
      <path d="M16.8 22.6l3.6-4.8 0.8 0.6-3.6 4.8-0.8-0.6z" />
    </svg>
