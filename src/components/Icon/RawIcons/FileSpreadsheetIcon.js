...
export default function FileSpreadsheetIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M16.5 12h-9c-0.275 0-0.5 0.225-0.5 0.5v7c0 0.275 0.225 0.5 0.5 0.5h9c0.275 0 0.5-0.225 0.5-0.5v-7c0-0.275-0.225-0.5-0.5-0.5zM16 16h-2v-2h2v2zM11 16v-2h2v2h-2zM13 17v2h-2v-2h2zM10 14v2h-2v-2h2zM8 17h2v2h-2v-2zM14 19v-2h2v2h-2z" />
    </svg>
