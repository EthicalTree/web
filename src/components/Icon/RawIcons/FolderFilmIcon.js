...
export default function FolderFilmIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M17.5 11h-11c-0.275 0-0.5 0.225-0.5 0.5v6c0 0.275 0.225 0.5 0.5 0.5h11c0.275 0 0.5-0.225 0.5-0.5v-6c0-0.275-0.225-0.5-0.5-0.5zM17 13h-1v-1h1v1zM8 15h-1v-1h1v1zM9 12h6v5h-6v-5zM16 14h1v1h-1v-1zM8 12v1h-1v-1h1zM7 16h1v1h-1v-1zM16 17v-1h1v1h-1z" />
    </svg>
