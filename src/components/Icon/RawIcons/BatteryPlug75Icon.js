...
export default function BatteryPlug75Icon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M3 18v-8h1v8h-1zM6 18v-8h-1v8h1zM8 18v-8h-1v8h1zM10 18v-6h-1v6h1zM12 18v-5h-1v5h1zM13 18h1v-4h-1v4z" />
    </svg>
