...
export default function ArrowRightSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M12.044 15.544l1.416 1.416 4.25-4.25c0.391-0.391 0.391-1.025 0-1.416l-4.25-4.25-1.416 1.416 2.544 2.544h-8.587v2h8.584l-2.541 2.541z" />
    </svg>
