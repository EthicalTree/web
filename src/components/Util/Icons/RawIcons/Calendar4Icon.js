...
export default function Calendar4Icon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M22 4h-3v2h3v16h-15v-4.5c0-0.275-0.225-0.5-0.5-0.5h-4.5v-11h3v-2h-3c-1.103 0-2 0.897-2 2v11c0 3.859 3.141 7 7 7h15c1.103 0 2-0.897 2-2v-16c0-1.103-0.897-2-2-2zM2.1 18h3.9v3.9c-1.956-0.4-3.5-1.944-3.9-3.9z" />
      <path d="M11 9h2v1h-2v-1z" />
      <path d="M14 9h2v1h-2v-1z" />
      <path d="M17 9h2v1h-2v-1z" />
      <path d="M8 11h2v1h-2v-1z" />
      <path d="M11 11h2v1h-2v-1z" />
      <path d="M14 11h2v1h-2v-1z" />
      <path d="M17 11h2v1h-2v-1z" />
      <path d="M5 11h2v1h-2v-1z" />
      <path d="M8 13h2v1h-2v-1z" />
      <path d="M11 13h2v1h-2v-1z" />
      <path d="M14 13h2v1h-2v-1z" />
      <path d="M17 13h2v1h-2v-1z" />
      <path d="M5 13h2v1h-2v-1z" />
      <path d="M8 15h2v1h-2v-1z" />
      <path d="M11 15h2v1h-2v-1z" />
      <path d="M14 15h2v1h-2v-1z" />
      <path d="M17 15h2v1h-2v-1z" />
      <path d="M5 15h2v1h-2v-1z" />
      <path d="M8 17h2v1h-2v-1z" />
      <path d="M11 17h2v1h-2v-1z" />
      <path d="M14 17h2v1h-2v-1z" />
      <path d="M17 17h2v1h-2v-1z" />
      <path d="M8 19h2v1h-2v-1z" />
      <path d="M11 19h2v1h-2v-1z" />
      <path d="M14 19h2v1h-2v-1z" />
      <path d="M17 19h2v1h-2v-1z" />
    </svg>
