...
export default function FileLockIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      <path d="M15.5 13h-0.5v-1c0-1.653-1.347-3-3-3s-3 1.347-3 3v1h-0.5c-0.275 0-0.5 0.225-0.5 0.5v4c0 0.275 0.225 0.5 0.5 0.5h7c0.275 0 0.5-0.225 0.5-0.5v-4c0-0.275-0.225-0.5-0.5-0.5zM10 12c0-1.103 0.897-2 2-2s2 0.897 2 2v1h-4v-1zM15 17h-6v-3h6v3z" />
