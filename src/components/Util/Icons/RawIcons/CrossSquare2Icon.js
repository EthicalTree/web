...
export default function CrossSquare2Icon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M9.462 15.95l2.538-2.534 2.538 2.534 1.413-1.413-2.534-2.538 2.534-2.538-1.413-1.413-2.538 2.534-2.538-2.534-1.413 1.413 2.534 2.538-2.534 2.538z" />
    </svg>
