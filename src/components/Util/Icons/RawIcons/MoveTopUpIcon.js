...
export default function MoveTopUpIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M11 3.416v6.584h2v-6.584l1.544 1.544 1.416-1.416-3.25-3.25c-0.391-0.391-1.025-0.391-1.416 0l-3.25 3.25 1.416 1.416 1.541-1.544z" />
    </svg>
