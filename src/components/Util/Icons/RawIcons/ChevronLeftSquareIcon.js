...
export default function ChevronLeftSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M13.544 17.956l1.416-1.416-4.544-4.541 4.544-4.544-1.416-1.416-5.25 5.25c-0.391 0.391-0.391 1.025 0 1.416l5.25 5.25z" />
    </svg>
