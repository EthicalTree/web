...
export default function StopSquareIcon(props) {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" {...props}>
      ...
      <path d="M8.5 16h7c0.275 0 0.5-0.225 0.5-0.5v-7c0-0.275-0.225-0.5-0.5-0.5h-7c-0.275 0-0.5 0.225-0.5 0.5v7c0 0.275 0.225 0.5 0.5 0.5zM9 9h6v6h-6v-6z" />
    </svg>
